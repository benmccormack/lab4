 ...
 */
export declare function joinAllInternals<T, R>(joinFn: (sources: ObservableInput<T>[]) => Observable<T>, project?: (...args: any[]) => R): import("rxjs/src/internal/types").UnaryFunction<Observable<ObservableInput<T>>, unknown>;
